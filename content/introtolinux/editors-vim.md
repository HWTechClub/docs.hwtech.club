+++
title = "Editors (Vim)"
date =  2020-08-22T14:26:09+04:00
weight = 7
+++
...
- Start with a tutorial (i.e. this guide, plus resources that we point out)
...
Many programs use the [GNU Readline](https://tiswww.case.edu/php/chet/readline/rltop.html) library for
...
Firefox. You can even get Vim bindings in [Jupyter notebooks](https://github.com/lambdalisue/jupyter-vim-binding).
...
4. To practice using Vim, re-do the [Demo](#demo) from lecture on your own
   machine.
...
8. (Advanced) Convert XML to JSON ([example file](/2020/files/example-data.xml))
