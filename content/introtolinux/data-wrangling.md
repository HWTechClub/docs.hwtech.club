...
date =  2020-08-22T14:52:21+04:00
weight = 8
+++
...
what this guide is all about. Specifically, massaging data, whether in
text or binary format, until you end up with exactly what you wanted.

Pretty much any time you use the `|` operator, you are performing some kind of
